...
public class LoginBean {
    ...
    public String login() {
        if(username.equals("scott") && password.equals("tiger")) {
            ...
            FacesMessage oracleMessage = new FacesMessage(bundle.getString("validation.oracle"));
            oracleMessage.setSeverity(FacesMessage.SEVERITY_ERROR);
            context.addMessage(null, oracleMessage);
            return "index";
        }
